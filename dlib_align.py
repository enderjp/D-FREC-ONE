# -*- coding: utf-8 -*-
"""
Created on Thu Feb 25 16:26:29 2021
...
def dlib_alignment(img,h,w):
    ...
    #img2 = dlib.load_rgb_image(face_file_path)
   ...
   # window = dlib.image_window()
    ...
    # Optionally: 
    images = dlib.get_face_chips(img, faces,size=320, padding=0.25) #320, 0.25
